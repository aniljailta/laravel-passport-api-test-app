...
class UserRepository extends BaseRepository
{
    ...
    {   
        ...
        $user_details->father_name = $input['father'];
        $user_details->mother_name = $input['mother'];
        $user_details->wife = $input['wife'];
        $user_details->child_name = $input['child'];
        $user_details->save();

        $user_address = new UserAddress;
        $user_address->user_id =$id;
        $user_address->street = $input['street'];
        $user_address->city = $input['city'];
        $user_address->state = $input['state'];
        $user_address->country = $input['country'];
        $user_address->zip_code = $input['zipcode'];
