<nav class="navbar navbar-expand-lg navbar-light bg-light mb-4">
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
        <ul class="navbar-nav">
            ...
            <div class="non-auth" style="display:none">
            ...
            <div class="non-auth" style="display:none">
                ...
                <li class="">
                    ...
                    <div class="auth" style="display:none">
                        <a id ="logout" href="{{ route('frontend.auth.logout') }}" class="dropdown-item">@lang('navs.general.logout')</a>
                        </div>
                </li>
...
$('#logout').click(function(){
    localStorage.setItem("acessToken",'logout');
