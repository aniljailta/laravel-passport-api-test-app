                    ...
                    <div class="row">
                        <div class="col col-sm-4 order-1 order-sm-2  mb-4">
                            ...
                            @if(!is_null($user->avatar_location))
                                <img class="card-img-top" width="50" height="150" src="{{ url('storage/'.$user->avatar_location) }}" alt="Profile Picture">
                            @endif
                                <div class="card-body">
                                    <h4 class="card-title">
                                        {{ $user->name }}<br/>
                                    ...
                                    <p class="card-text">
                                        ...
                                        <a href="{{ route('frontend.user.account',$user->id)}}" class="btn btn-info btn-sm mb-1">
